...
def _execute_selection(
    *,
    ...
    top_revenue = store.top_metric_by_year(
        metric_id="revenue",
        fiscal_year=top_revenue_year,
        limit=3,
        document_ids=selected_document_ids,
    )
    top_revenue_stats = store.top_metric_by_year_stats(
        metric_id="revenue",
        fiscal_year=top_revenue_year,
        limit=3,
        document_ids=selected_document_ids,
    ...
    return {
        ...
        "selected_scope_revenue_top3": [fact.model_dump(mode="json") for fact in top_revenue],
        "selected_scope_revenue_top3_stats": top_revenue_stats,
